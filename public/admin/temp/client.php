  ...
  $data->id=$_GET['sid'];
    ...
    <script>
	  ...
	  {	
		...
		window.location="client.php?sid=<?=$_GET['sid']?>";
	  }
...
if(isset($_GET['did']) && $_GET['did']!=''){
  $Client = Client::find_by_id($_GET['did']);
  $Client->delete(); 
  	?>
    <script>
		function Redirect()
	  {	
	 		window.location="client.php?do=show";
	  }
	  setTimeout('Redirect()', 0);
	</script>
    <?php  
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="head clearfix">
          ...
          <h1>Show Client</h1>
          <div class="rright" align="right"><a href="client.php"><strong style="color:#FFF; padding: 8px 10px 0 0; float:right;">&nbsp;Add Client</strong><i style="float:right; padding-top:8px; padding-left: 10px;"class="isw-list"></i></a></div>
        </div>
                ...
                <tr class="item">
                  ...
                  <td class="subject"><?php
					   if($row2->image!='')
					   {
						   ...
						   echo' <a class="fancybox" rel="group" href="../../public/editor/files/Uploads/client/'.$row2->image.'">
    <img src="../../public/editor/files/Uploads/client/'.$row2->image.'"  class="img-polaroid" width="60" height="60" border="0"></a>';
						   }
                       ?></td>
                  <td class="action"><a href="client.php?sid=<?=$row2->id?>" class="icon-pencil"></a>
                   <a href="javascript:confirmDelete('client.php?did=<?=$row2->id?>')" class="isb-delete" ></a></td>
                </tr>
                <?php  
        ...
        <div class="head clearfix">
          ...
          <div class="right" align="right"><a href="client.php?do=show"><strong style="color:#FFF; padding: 8px 10px 0 0; float:right;">&nbsp;Show Client</strong><i style="float:right; padding-top:8px; padding-left: 10px;"class="isw-list"></i></a></div>
        </div>
        <div class="block-fluid table-sorting clearfix">
				  ...
				  if(isset($_GET['sid']))
		  {
							 ...
							 {
								 ?>
                    <div> <a class="fancybox" rel="group" href="../../public/editor/files/Uploads/client/<?=$rw->image?>"><img class="img-polaroid" src="../../public/editor/files/Uploads/client/<?=$rw->image?>" width="60" height="60" /></a></div>
